/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=apps/finance-worker/wrangler.jsonc apps/finance-worker/worker-configuration.d.ts` (hash: 8d4b3f799cb43e39b89be68dd017443a)
...
interface __BaseEnv_Env {
	...
	JOBS: Queue;
	ASSETS: Fetcher;
	APP_ENV: "sandbox" | "production" | "local";
	APP_ORIGIN: "https://REPLACE-SANDBOX.workers.dev" | "https://REPLACE-PRODUCTION.workers.dev" | "http://localhost:8787";
...
declare namespace Cloudflare {
	...
	interface SandboxEnv {
		...
		ASSETS: Fetcher;
		APP_ENV: "sandbox";
		APP_ORIGIN: "https://REPLACE-SANDBOX.workers.dev";
		PLAID_ENV: "sandbox";
		TIMEZONE: "America/Toronto";
		TOKEN_KEY_VERSION: "1";
	}
	interface ProductionEnv {
		...
		ASSETS: Fetcher;
		APP_ENV: "production";
		APP_ORIGIN: "https://REPLACE-PRODUCTION.workers.dev";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_ENV" | "APP_ORIGIN" | "PLAID_ENV" | "TIMEZONE" | "TOKEN_KEY_VERSION">> {}
}
